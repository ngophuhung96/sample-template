...
public class LicensePlateServiceImpl implements LicensePlateService {
	...
	@Override
	public List<LicensePlateResponse> getLicensePlate() throws JsonProcessingException {
	...
	@Cacheable(cacheNames = Constants.FIND_PROVINCE_BY_PROVINCE_LICENSE_PLATE_CODE_FROM_POSTGRES_DB)
	@Override
	public List<LicensePlateResponse> getByLicensePlateCode(String licensePlateCode) throws JsonProcessingException {
		...
		List<MstProvince> mstProvinceList = provinceRepository.findProvinceByLicensePlateCode(licensePlateCode);
